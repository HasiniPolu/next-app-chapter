...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Live commodity prices, AI forecasts and personalized watchlists." },
      { name: "author", content: "SentiMarket" },
      { name: "theme-color", content: "#1A1F5E" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "SentiMarket" },
